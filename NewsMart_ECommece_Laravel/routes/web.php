...
Route::prefix('user')->name('user.')->group(function () {
    ...
    Route::post('/ho-so', [KhachHangController::class, 'postHoSo'])->name('hoso'); // Đổi mật khẩu
...
Route::prefix('admin')->name('admin.')->group(function () {
	...
	Route::post('/poststatus/add', [PostStatusController::class, 'postAdd'])->name('post_status.add');
	...
	Route::get('/profile/change-password', [UserController::class, 'getChangePasswordForm'])->name('profile.changepassword_form');
	Route::post('/profile/change-password', [UserController::class, 'postChangePassword'])->name('profile.changepassword');
});
