...
Route::get('/order_statuses', [OrderStatusController::class, 'getList'])->name('order_statuses');
Route::get('/order_statuses/add', [OrderStatusController::class, 'getAdd'])->name('order_statuses.add');
Route::post('/order_statuses/add', [OrderStatusController::class, 'postAdd'])->name('order_statuses.add');
Route::get('/order_statuses/update/{id}', [OrderStatusController::class, 'getUpdate'])->name('order_statuses.update');
Route::post('/order_statuses/update/{id}', [OrderStatusController::class, 'postUpdate'])->name('order_statuses.update');
Route::get('/order_statuses/delete/{id}', [OrderStatusController::class, 'getDelete'])->name('order_statuses.delete');
