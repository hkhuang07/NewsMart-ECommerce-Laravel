...
<head>
    ...
    <!-- Favicon -->
    <link rel="preload" href="{{ asset('public/favicon.ico') }}" as="image" type="image/x-icon">
    ...
    <nav class="sidebar" id="sidebar">
        <div class="sidebar-header">
            <a class="navbar-brand" href="{{ route('frontend') }}">
                <img src="{{ asset('public/favicon.ico') }}" alt="{{ config('app.name', 'Laravel') }} Logo" class="navbar-logo">
