...
<script>
    ...
    /**
     * Hàm mở modal Update và đổ dữ liệu người dùng
     * CẬP NHẬT: Đảm bảo Modal được khởi tạo đúng và dữ liệu được đổ đầy đủ.
     * @param {string} userId - ID của người dùng
     * @param {object} userData - Dữ liệu người dùng (phải bao gồm role relationship)
     */
