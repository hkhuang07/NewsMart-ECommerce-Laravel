...
function openUpdateModal(orderStatusId, orderStatusData) {
    ...
    form.action = `<?php echo e(route('order_statuses.update', ['id' => '__ID__'])); ?>`.replace('__ID__', orderStatusId);
...
<?php /**PATH C:\wamp64\www\Project\NewsMart_ECommece_Laravel\resources\views/order_statuses/update.blade.php ENDPATH**/ ?>