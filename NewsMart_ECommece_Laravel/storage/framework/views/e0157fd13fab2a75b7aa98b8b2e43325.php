...
<head>
    ...
    <!-- Favicon -->
    <link rel="preload" href="<?php echo e(asset('public/favicon.ico')); ?>" as="image" type="image/x-icon">
    ...
    <link rel="apple-touch-icon" href="<?php echo e(asset('public/favicon.ico')); ?>">

    <!-- Stylesheets -->
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/css/bootstrap.min.css" />
    <link rel="stylesheet" href="<?php echo e(asset('public/vendor/font-awesome/css/all.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('public/css/custom.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('public/css/list.css')); ?>" />
    ...
    <nav class="sidebar" id="sidebar">
        <div class="sidebar-header">
            <a class="navbar-brand" href="<?php echo e(route('frontend')); ?>">
                <img src="<?php echo e(asset('public/favicon.ico')); ?>" alt="<?php echo e(config('app.name', 'Laravel')); ?> Logo" class="navbar-logo">
        ...
        <ul class="sidebar-nav">
            ...
            <li class="nav-item">
                <span class="nav-link">
                    <i class="fas fa-user-circle"></i> <?php echo e(Auth::user()->FullName ?? Auth::user()->name); ?>

                    <span class="badge-role"><?php echo e(getUserRole()); ?></span>
                </span>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault();document.getElementById('logout-form-sidebar').submit();">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo e(route('frontend')); ?>">
            ...
            <li class="nav-item">
                ...
                <div class="collapse sidebar-submenu" id="contentManagement">
                    <a class="nav-link" href="<?php echo e(route('topic')); ?>">
                        <i class="fas fa-tags"></i> Post Topics
                    </a>
                    <a class="nav-link" href="<?php echo e(route('posttype')); ?>">
            ...
            <li class="nav-item">
                ...
                <div class="collapse sidebar-submenu" id="orderSystemManagement">
                    <a class="nav-link" href="<?php echo e(route('order_statuses')); ?>">
            ...
            <li class="nav-item">
                <button class="sidebar-dropdown collapsed" data-bs-toggle="collapse" data-bs-target="#productManagement">
                    <i class="fas fa-box"></i> <?php if(isSaler()): ?> My Products <?php else: ?> Products <?php endif; ?>
                    <i class="fas fa-chevron-down dropdown-icon"></i>
                </button>
                <div class="collapse sidebar-submenu" id="productManagement">
                    <a class="nav-link" href="<?php echo e(route('product')); ?>">
                        <i class="fas fa-cube"></i> <?php if(isSaler()): ?> My Product List <?php else: ?> All Products <?php endif; ?>
                    </a>
                    <?php if(!isSaler()): ?>
                    <a class="nav-link" href="#">
            ...
            <li class="nav-item">
                <button class="sidebar-dropdown collapsed" data-bs-toggle="collapse" data-bs-target="#orderManagement">
                    ...
                    <?php if(isSaler()): ?> My Orders
                    <?php elseif(isShipper()): ?> Delivery Orders
                    <?php else: ?> Orders
                    <?php endif; ?>
                    <i class="fas fa-chevron-down dropdown-icon"></i>
                </button>
                <div class="collapse sidebar-submenu" id="orderManagement">
                    <a class="nav-link" href="<?php echo e(route('order')); ?>">
                        ...
                        <?php if(isSaler()): ?> Sales Orders
                        <?php elseif(isShipper()): ?> Assigned Orders
                        <?php else: ?> All Orders
                        <?php endif; ?>
                    </a>
                    <?php if(isShipper()): ?>
            ...
            <?php if(canViewReports() && !hasAdminAccess()): ?>
            <li class="nav-item">
                <a class="nav-link" href="#">
                    <i class="fas fa-chart-bar"></i>
                    <?php if(isSaler()): ?> Revenue Reports
                    <?php else: ?> Reports & Analytics
                    <?php endif; ?>
                </a>
            </li>
            <?php endif; ?>
    ...
    <div class="container-fluid">
        ...
        <nav class="navbar navbar-expand-lg navbar-custom">
            <div class="container-fluid">
                ...
                <!-- Brand >
                <a class="navbar-brand" href="<?php echo e(route('frontend')); ?>">
                    <i class="fas fa-shopping-cart"></i> <?php echo e(config('app.name', 'Laravel')); ?>
                ...
                <div class="collapse navbar-collapse" id="navbarMain">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="<?php echo e(route('category')); ?>">
                                        <i class="fas fa-sitemap"></i> Categories
                                    </a></li>
                                <li><a class="dropdown-item" href="<?php echo e(route('brand')); ?>">
                                        <i class="fas fa-copyright"></i> Brands
                                    </a></li>
                            </ul>
                        </li>
        ...
        <footer>
            <div class="container py-5">
                ...
                <div class="footer-service-intro p-4 mb-5 rounded">
                    <h2 class="mb-4">
                        <i class="fas fa-city me-2"></i><?php echo e(config('app.name', 'Laravel')); ?>: Integrated Platform for Urban Life
                    </h2>
                    <p class="lead">
                        <?php echo e(config('app.name', 'Laravel')); ?> is an integrated ecosystem that delivers essential services for modern living.
                ...
                <div class="row g-4 mb-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-column p-4 h-100 rounded">
                            ...
                            <div class="d-flex flex-column gap-1">
                                ...
                                <a href="#" class="footer-link-item">
                                    <i class="fas fa-blog me-2"></i><?php echo e(config('app.name', 'Laravel')); ?> Blog
                                </a>
                                <a href="#" class="footer-link-item">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-column p-4 h-100 rounded">
                            <h3 class="mb-4">
                                <i class="fas fa-info-circle me-2"></i>About <?php echo e(config('app.name', 'Laravel')); ?>
                ...
                <div class="footer-bottom pt-4 text-center">
                    ...
                    <div class="footer-company-info">
                        <p class="mb-2">&copy; <?php echo e(date('Y')); ?> <?php echo e(config('app.name', 'Laravel')); ?> by NewsMart Team. All rights reserved.</p>
                        <p class="mb-2"><?php echo e(config('app.name', 'Laravel')); ?> Technology Company Limited</p>
                        <p class="mb-0">
...
</html><?php /**PATH C:\wamp64\www\Project\NewsMart_ECommece_Laravel\resources\views/layouts/app.blade.php ENDPATH**/ ?>