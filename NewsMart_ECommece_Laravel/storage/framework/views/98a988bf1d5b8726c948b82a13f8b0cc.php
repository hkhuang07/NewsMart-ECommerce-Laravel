...
<script>
    ...
    function openUpdateModal(roleId, roleData) {
        ...
        updateForm.action = `<?php echo e(route('role.update', ['id' => '__ID__'])); ?>`.replace('__ID__', roleId);
...
<?php /**PATH C:\wamp64\www\Project\NewsMart_ECommece_Laravel\resources\views/roles/update.blade.php ENDPATH**/ ?>