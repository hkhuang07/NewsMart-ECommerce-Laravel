    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content item-modal">
            ...
            <div class="modal-body">
                ...
                <form id="addRoleForm" action="<?php echo e(route('role.add')); ?>" method="post">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input
                            type="text"
                            class="form-control item-input <?php $__errorArgs = ['slug'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            name="description"
                            rows="4"
                            placeholder="Describe this role"><?php echo e(old('description')); ?></textarea>
...
<?php /**PATH C:\wamp64\www\Project\NewsMart_ECommece_Laravel\resources\views/roles/add.blade.php ENDPATH**/ ?>